          ...
          <div className="container pb-8 sm:pb-0">
            <div className="grid grid-cols-1 sm:grid-cols-2">
              ...
              <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1">
                ...
                Imagine sinking your teeth into a perfectly grilled patty, sizzling with flavor, nestled between a soft, toasted bun. Each burger is customizable, allowing you to choose from a variety of gourmet toppings, fresh veggies, and artisanal sauces. Whether you’re a fan of classic cheeseburgers or adventurous gourmet creations, we’ve got you covered.
                </p>
